function onSay(cid, words, param)
    ...
    if players > 1 then
  playersmsg = "No Server tem ".. players .." players online."
    else
  playersmsg = "You are the only player online."    
    end
    if creatures > 1 then
  creaturesmsg = "No Server tem ".. creatures .." creatures spawned."
    elseif creatures == 1 then
  creaturesmsg = "No Server tem 1 creature spawned."
    else
  ...
  npcsmsg = "There is currently ".. npcs .." NPCs online."
    elseif npcs == 1 then
  npcsmsg = "No Server tem 1 NPC online."
    else
