...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, 0, -2000, 0, -3200)
...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, 0, -3000, 0, -3200)
...
doPlayerSay(cid, "Blue Eletrifick!!",16)
else
