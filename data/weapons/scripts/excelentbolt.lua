...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, 0, -18000, 0, -28600)
...
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, 0, -18000, 0, -32600)
...
if rand == 99 then
doSendAnimatedText(getPlayerPosition(cid), "Fell My Fury", TEXTCOLOR_LIGHTGREY)
doPlayerAddHealth(cid,1000)
