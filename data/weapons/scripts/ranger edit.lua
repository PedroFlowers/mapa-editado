...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, 0, -5032000, 0, -5032000)
...
setConditionFormula(condition, 570000, 1000, -690000)
...
if rand == 99 then
doSendAnimatedText(getPlayerPosition(cid), "Ancient", TEXTCOLOR_LIGHTGREEN)
