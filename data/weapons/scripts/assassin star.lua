...
setCombatFormula(combat, COMBAT_FORMULA_LEVELMAGIC, 0, -11400, 0, -19600)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 31)
setCombatParam(combat2, COMBAT_PARAM_BLOCKARMOR, TRUE)
setCombatParam(combat2, COMBAT_PARAM_DISTANCEEFFECT, CONST_ANI_ASSASSINSTAR)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, 0, -13400, 0, -21600)
...
if rand == 99 then
doSendAnimatedText(getPlayerPosition(cid), "Assassin", TEXTCOLOR_RED)
