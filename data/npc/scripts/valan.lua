...
if string.find(msg, '(%a*)oi(%a*)') and focus == cid then
selfSay('Oi sou feliz')
talk_start = os.clock()
end

if string.find(msg, '(%a*)trocar(%a*)') and focus == cid then
itemstatus = doPlayerRemoveItem(cid,2036,1)
if itemstatus == -1 then
selfSay('Você não tem o item!')
else
selfSay('Vamos trocar!')
buy(cid,6090,1,0)
talk_start = os.clock()
end
end
