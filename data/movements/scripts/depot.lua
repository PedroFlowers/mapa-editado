function onStepIn(cid, item, pos) 
	...
	if item.actionid > 100 and item.actionid < 120 then
		...
		if(depot == 1) then
	doPlayerSendTextMessage(cid, 21, "Your depot contains 1 item.")
		elseif(depot == -1) then
	doPlayerSendTextMessage(cid, 21, "FATAL ERROR: DEPOTID DOES NOT EXIST ON THIS CHARACTER! (DEPOTID: " .. depotid .. ")")
		elseif(depot > 1) then
	doPlayerSendTextMessage(cid, 21, "Your depot contains " .. depot .. " items.")
		end
	end
